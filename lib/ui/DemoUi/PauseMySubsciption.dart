...
class _HomeScreenState extends State<PauseSubscription> {
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          ...
                                          snapshot.data.data.address.fullAddress.toString(): '',
                                          style: TextStyle(
                                              fontSize: 15,
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              ...
                                              snapshot.data.data.order.mealsServed.toString(),
  ...
  Future<void> reactiveSubcription() async {
   ...
   getPauseList() async {
    ...
    PauseScreenDataResponse pauseScreenDataResponse = PauseScreenDataResponse.fromJson(res);
