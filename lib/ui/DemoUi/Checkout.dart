...
// import 'package:flutter_sheplates/modals/request/CreateOrderRazorRequest.dart';
...
// import 'package:flutter_sheplates/modals/response/CreateOrderRazorRespone.dart';
...
class _HomeScreenState extends State<Checkout> {
  ...
  Future<void> completePayment(
    ...
    PaymentSubmitRequest request = PaymentSubmitRequest(
      ...
      amount: stockCheckOutResponse.data.orders.total_amount.toInt(),
    );
  ...
  void openCheckout(String name, num amount, String order_id, ) async {
  ...
  Future<void> submit1() async {
    ...
    CreateOrderOnRazorRequest request = CreateOrderOnRazorRequest(
      ...
      amount: stockCheckOutResponse.data.orders.total_amount*100,
    );
    ...
    if (orderResponse.status == 200) {
      ...
      openCheckout(name, amount, orderId,
          // email, phone
      );
  ...
  String calculatePrice() {
    return (stockCheckOutResponse.data.orders.total_amount -
        (stockCheckOutResponse.data.orders.gst_amount +
            stockCheckOutResponse.data.orders.packaging_charges +
            stockCheckOutResponse.data.orders.delievery_charges))
        .toStringAsFixed(2);
  }
