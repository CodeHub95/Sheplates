...
class PastWidgetTabData extends StatefulWidget {
  ...
  PastWidgetTabData(this.subscriptionData);
  @override
  _PastWidgetTabDataState createState() => _PastWidgetTabDataState(subscriptionData);
}

class _PastWidgetTabDataState extends State<PastWidgetTabData> {
  List<dynamic> subscriptionData;
  _PastWidgetTabDataState(this.subscriptionData);
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: Text(
                                            subscriptionData[index].orders[0].catalog.mealCategory.toString(),
                                              ...
                                              child: Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      subscriptionData[index].orders[0].kitchen.toString(),
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          subscriptionData[index].orders[0].endDate.toString(),
                                                        )
                                                      ],
                                                    )
                                                  ],
                                        ...
                                        Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Text(
                                                subscriptionData[index].orders[0].duration.toString(),
                                        ...
                                        Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Text(
                                                subscriptionData[index].orders[0].startDate.toString(),
                                                style: TextStyle(color: Colors.black, fontSize: 16),
                                              )
                                            ],
                                          ),
