...
class ActiveWidgetTabData extends StatefulWidget {
  List<dynamic> activeSubscriptionList;
  ActiveWidgetTabData(this.activeSubscriptionList);
  @override
  _ActiveWidgetTabDataState createState() => _ActiveWidgetTabDataState(activeSubscriptionList);
}

class _ActiveWidgetTabDataState extends State<ActiveWidgetTabData> {
  List<dynamic> activeSubscriptionList;
  _ActiveWidgetTabDataState(this.activeSubscriptionList);
    ...
    return Scaffold(
      body: SingleChildScrollView(
          child: activeSubscriptionList.isEmpty
              ? SizedBox(height: MediaQuery.of(context).size.height * .7, child: Center(child: Text("No data found")))
              : Column(
                  children: [
                    Container(
